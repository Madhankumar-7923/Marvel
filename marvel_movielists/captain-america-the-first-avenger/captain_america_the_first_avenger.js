...
function handleIntersection(entries, observer) {
    entries.forEach(entry => {
        if (entry.isIntersecting) {
            animateValue("budget", 0, 140000000, 2000, 'USD');
            animateValue("gross-us-canada", 0, 176654505, 2000, 'USD');
            animateValue("opening-weekend", 0, 65058524, 3000, 'USD');
            animateValue("gross-india", 0, `${grossIndia}`, 3000, 'INR');
            animateValue("gross-worldwide", 0, 370569774, 3000, 'USD');
