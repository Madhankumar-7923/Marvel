...
function handleIntersection(entries, observer) {
    entries.forEach(entry => {
        if (entry.isIntersecting) {
            ...
            animateValue("gross-us-canada", 0, 206362140, 2000, 'USD');
            animateValue("opening-weekend", 0, 85737841, 2000, 'USD');
            animateValue("gross-india", 0, 300474495, 3000, 'INR');
            animateValue("gross-worldwide", 0, 644783140, 3000, 'USD');
