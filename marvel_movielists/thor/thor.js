...
function handleIntersection(entries, observer) {
    entries.forEach(entry => {
        if (entry.isIntersecting) {
            ...
            animateValue("gross-us-canada", 0, 181030624, 2000, 'USD');
            animateValue("opening-weekend", 0, 65723338, 2000, 'USD');
            animateValue("gross-india", 0, 93485722, 3000, 'INR');
            animateValue("gross-worldwide", 0, 449326618, 3000, 'USD');
