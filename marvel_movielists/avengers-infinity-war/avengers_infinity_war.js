...
function handleIntersection(entries, observer) {
    entries.forEach(entry => {
        if (entry.isIntersecting) {
            animateValue("budget", 0, 321000000, 2000, 'USD');
            animateValue("gross-us-canada", 0, 678815482, 2000, 'USD');
            animateValue("opening-weekend", 0, 257698183, 2000, 'USD');
            animateValue("gross-india", 0, 1566300000, 3000, 'INR');
            animateValue("gross-worldwide", 0, 2052415039, 3000, 'USD');
