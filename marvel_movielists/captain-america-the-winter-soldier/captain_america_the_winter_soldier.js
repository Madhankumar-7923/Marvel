...
function handleIntersection(entries, observer) {
    entries.forEach(entry => {
        if (entry.isIntersecting) {
            animateValue("budget", 0, 170000000, 2000, 'USD');
            animateValue("gross-us-canada", 0, 259766572, 2000, 'USD');
            animateValue("opening-weekend", 0, 95023721, 2000, 'USD');
            animateValue("gross-india", 0, 1048590000, 3000, 'INR');
            animateValue("gross-worldwide", 0, 714421503, 3000, 'USD');
