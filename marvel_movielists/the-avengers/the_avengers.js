...
function handleIntersection(entries, observer) {
    entries.forEach(entry => {
        if (entry.isIntersecting) {
            animateValue("budget", 0, 220000000, 2000, 'USD');
            animateValue("gross-us-canada", 0, 623357910, 2000, 'USD');
            animateValue("opening-weekend", 0, 207438708, 2000, 'USD');
            animateValue("gross-india", 0, 153485722, 3000, 'INR');
            animateValue("gross-worldwide", 0, 1520538536, 3000, 'USD');
