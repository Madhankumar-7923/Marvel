...
function handleIntersection(entries, observer) {
    entries.forEach(entry => {
        if (entry.isIntersecting) {
            animateValue("budget", 0, 175000000, 2000, 'USD');
            animateValue("gross-us-canada", 0, 334952829, 2000, 'USD');
            animateValue("opening-weekend", 0, 117027503, 2000, 'USD');
            animateValue("gross-india", 0, 417000000, 3000, 'INR');
            animateValue("gross-worldwide", 0, 880918840, 3000, 'USD');
