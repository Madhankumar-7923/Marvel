...
function handleIntersection(entries, observer) {
    entries.forEach(entry => {
        if (entry.isIntersecting) {
            ...
            animateValue("gross-us-canada", 0, 312433331, 2000, 'USD');
            animateValue("opening-weekend", 0, 128122480, 2000, 'USD');
            animateValue("gross-india", 0, 102907298, 3000, 'INR');
            animateValue("gross-worldwide", 0, 623933331, 3000, 'USD');
