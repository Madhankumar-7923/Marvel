...
function handleIntersection(entries, observer) {
    entries.forEach(entry => {
        if (entry.isIntersecting) {
            animateValue("budget", 0, 356000000, 2000, 'USD');
            animateValue("gross-us-canada", 0, 858373000, 2000, 'USD');
            animateValue("opening-weekend", 0, 357115007, 3000, 'USD');
            animateValue("gross-india", 0, 4380000000, 3000, 'INR');
            animateValue("gross-worldwide", 0, 2799439100, 3000, 'USD');
