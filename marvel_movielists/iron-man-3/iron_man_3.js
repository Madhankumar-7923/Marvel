...
function handleIntersection(entries, observer) {
    entries.forEach(entry => {
        if (entry.isIntersecting) {
            animateValue("budget", 0, 200000000, 2000, 'USD');
            animateValue("gross-us-canada", 0, 409013994, 2000, 'USD');
            animateValue("opening-weekend", 0, 174144585, 2000, 'USD');
            animateValue("gross-india", 0, 505000000, 3000, 'INR');
            animateValue("gross-worldwide", 0, 1215577205, 3000, 'USD');
