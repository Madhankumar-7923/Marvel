...
function handleIntersection(entries, observer) {
    entries.forEach(entry => {
        if (entry.isIntersecting) {
            ...
            animateValue("gross-us-canada", 0, 319034126, 2000, 'USD');
            animateValue("opening-weekend", 0, 98618668, 2000, 'USD');
            animateValue("gross-india", 0, 164495512, 3000, 'INR');
            animateValue("gross-worldwide", 0, 585796247, 3000, 'USD');
