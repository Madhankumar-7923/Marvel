...
function handleIntersection(entries, observer) {
    entries.forEach(entry => {
        if (entry.isIntersecting) {
            ...
            animateValue("gross-us-canada", 0, 333718600, 2000, 'USD');
            animateValue("opening-weekend", 0, 94320883, 2000, 'USD');
            animateValue("gross-india", 0, 154700000, 3000, 'INR');
            animateValue("gross-worldwide", 0, 773350376, 3000, 'USD');
